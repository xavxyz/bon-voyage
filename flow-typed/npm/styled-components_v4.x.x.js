...
// ---- WITHCOMPONENT ----
type $npm$styledComponents$ComponentTypeWithComponent<ComponentList> = <
  Props,
  DefaultProps,
  Input:
    | ComponentList
    | $npm$styledComponents$ComponentType<Props, DefaultProps>
...
// ---- STATIC PROPERTIES ----
type $npm$styledComponents$ComponentTypeStaticProps<Props, ComponentList> = {|
  attrs: <AdditionalProps: {}>(
    AdditionalProps
  ) => $npm$styledComponents$ComponentTypeTaggedTemplateLiteral<
    Props & AdditionalProps,
    ComponentList
  >,
  extend: $npm$styledComponents$ComponentTypeTaggedTemplateLiteral<
    Props,
    ComponentList
  >,
|};

type $npm$styledComponents$ComponentTypeStaticPropsWithComponent<
  Props,
  ComponentList
> = {|
  withComponent: $npm$styledComponents$ComponentTypeWithComponent<ComponentList>,
  attrs: <AdditionalProps: {}>(
    AdditionalProps
  ) => $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
    Props & AdditionalProps,
    ComponentList
  >,
  extend: $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
    Props,
    ComponentList
  >,
|};
...
type $npm$styledComponents$Call<
  ComponentListKeys
> = (ComponentListKeys => $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
  {},
  ComponentListKeys
>) &
  (<Props>(
...
// ---- STYLED COMPONENT ----
type $npm$styledComponents$ComponentType<
  Props,
  ComponentList,
  DefaultProps = *
> = $npm$styledComponents$ComponentTypeStaticPropsWithComponent<
  Props,
  ComponentList
> &
...
type $npm$styledComponents$ComponentTypeTaggedTemplateLiteral<
  Props,
  ComponentList
> = $npm$styledComponents$ComponentTypeStaticProps<Props, ComponentList> &
  $npm$styledComponents$TaggedTemplateLiteral<
    $npm$styledComponents$ComponentType<Props, ComponentList>
  >;

type $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
  Props,
  ComponentList
> = $npm$styledComponents$ComponentTypeStaticPropsWithComponent<
  Props,
...
type $npm$styledComponents$StyledComponentsComponentListValue = $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
  {},
...
type $npm$styledComponents$StyledComponentsNativeComponentListValue = $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
  {},
...
declare module 'styled-components' {
  ...
  declare export type ComponentTypeStaticProps<
    Props
  > = $npm$styledComponents$ComponentTypeStaticPropsWithComponent<
    Props,
    ComponentListKeys
  ...
  declare export type ComponentType<
    Props
  > = $npm$styledComponents$ComponentType<Props, ComponentListKeys>;
  declare export type ComponentTypeTaggedTemplateLiteral<
    Props
  > = $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
    Props,
    ComponentListKeys
  ...
  declare export var createGlobalStyle: TaggedTemplateLiteral<string>;
...
declare module 'styled-components/native' {
  ...
  declare export type ComponentType<
    Props
  > = $npm$styledComponents$ComponentType<Props, NativeComponentListKeys>;
  declare export type ComponentTypeTaggedTemplateLiteral<
    Props
  > = $npm$styledComponents$ComponentTypeTaggedTemplateLiteralWithComponent<
    Props,
